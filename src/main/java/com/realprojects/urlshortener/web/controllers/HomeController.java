...
//Thymeleaf dependency was added in pom and html pages were moved from 'resources/static' to 'resources/templates'
    ...
    public String home(
        ...
        model.addAttribute("paginationUrl", "/");//check comment in pagination.html and it will make sense
...
//  short and base urls have been wrapped in page type using the helper metheod
    ...
    public String showUserUrls(
        ...
        model.addAttribute("baseUrl", properties.baseUrl());
        model.addAttribute("paginationUrl", "/my-urls");//check comment in pagination.html
        return "my-urls";
    }
